  ...
  const galleryItems: GalleryItem[] = [
    {
      ...
      dramaImageUrl: '/hero_yacht.png',
      dramaTitle: '해운대 & 광안대교 촬영지',
    ...
    {
      id: 2,
      tourImageUrl: '/gallery_tour2.png',
      dramaImageUrl: '/hero_tram_v7_wide_sharp.png',
      dramaTitle: '청사포 촬영지',
    ...
    {
      id: 3,
      tourImageUrl: '/gallery_tour1_v2.png',
      dramaImageUrl: '/gallery_life1_v2.png',
      dramaTitle: '한국 드라마속 스파 & 찜질방 체험',
      review: '부산의 푸른 바다를 배경으로 인생샷을 남길 수 있는 감성 카페 테라스입니다. 드라마 속 한 장면 같은 로맨틱한 분위기와 시원한 바다 바람을 즐겨보세요.',
    },
  ];
    ...
    <section className="gallery-section">
      <div className="container">
        <div className="gallery-header">
          <h2 className="section-title">오늘, 당신이라는 작품</h2>
          <div className="section-divider"></div>
          <p className="gallery-subtitle">Today’s Masterpiece, It’s You</p>
        </div>
          ...
          {galleryItems.map((item) => (
            <div key={item.id} className="comparison-card">
              <div className="comparison-images">
                ...
                <div className="comparison-side">
                  <img src={item.dramaImageUrl} alt="Life Shot" className="comp-img" />
                  <div className="comp-label">LIFE SHOT</div>
                </div>
              </div>
